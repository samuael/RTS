...
// Returns a string representation of the Date Struct
...
// // CorrectName Method to convert ethiopian Time to Modify The Date
// func (date *Date) CorrectName() *Date {
// 	today := NewDate(0)
// 	passedDays := date.Day - today.Day
// 	passedMonths := date.Month - today.Month
// 	passedYears := date.Year - today.Year
...
// 	sum := passedDays
// 	if date.Month == 1 && today.Month == 13 {
// 		sum += 7
// 	} else if date.Month == 1 && today.Month == 12 {
